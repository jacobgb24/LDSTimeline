...
public class StaticMapBuilder {
    ...
    private static final String URL = "https://maps.googleapis.com/maps/api/staticmap?center=MY_COORDS&zoom=" + Integer.toString(ZOOM) +  "&scale=2&format=png&maptype=roadmap&style=feature:administrative.land_parcel%7Celement:labels%7Cvisibility:off&style=feature:poi.government%7Cvisibility:off&style=feature:poi.attraction%7Celement:geometry%7Cvisibility:off&style=feature:poi.business%7Cvisibility:off&style=feature:poi.medical%7Cvisibility:off&style=feature:poi.school%7Cvisibility:off&style=feature:poi.sports_complex%7Cvisibility:off&style=feature:road%7Cvisibility:off&style=feature:transit%7Cvisibility:off&style=feature:road.local%7Celement:labels%7Cvisibility:off&size=640x360&markers=size:small%7Ccolor:0xff0000%7Clabel:%7CMY_COORDS";
